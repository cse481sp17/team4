...
class Head(object):
    ...
    """
    MIN_PAN = None  # TODO: Minimum pan angle, in radians. 90
    MAX_PAN = None  # TODO: Maximum pan angle, in radians. 90
    MIN_TILT = None  # TODO: Minimum tilt angle, in radians. 90 down
    MAX_TILT = None  # TODO: Maximum tilt angle, in radians.  45 up
